<?php
// Función PHP para convertir totales a otras monedas
define('USD_TO_COP', 4000); // Tasa de cambio ejemplo
define('USD_TO_VES', 35);   // Tasa de cambio ejemplo
